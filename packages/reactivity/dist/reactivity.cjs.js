...
class EffectScope {
  constructor(detached = false) {
     ...
     * @internal
     */
    __publicField$3(this, "_active", true);
    /**
     * @internal
     */
    __publicField$3(this, "effects", []);
    /**
     * @internal
     */
    __publicField$3(this, "cleanups", []);
    /**
...
class ReactiveEffect {
  constructor(fn, trigger, scheduler, scope) {
    ...
    __publicField$2(this, "active", true);
    /**
     * 多对多的关系，一个副作用函数可以包含多个依赖的响应对象，一个响应对象可以存在多个副作用函数中
     */
    __publicField$2(this, "deps", []);
    /**
     * Can be attached after creation
     * @internal
     */
    __publicField$2(this, "computed");
    /**
     * @internal
     */
    __publicField$2(this, "allowRecurse");
    __publicField$2(this, "onStop");
    // dev only
    __publicField$2(this, "onTrack");
    // dev only
    __publicField$2(this, "onTrigger");
    /**
     * @internal
     */
    __publicField$2(this, "_dirtyLevel", 2);
    /**
     * @internal
     */
    __publicField$2(this, "_trackId", 0);
    /**
     * @internal
     */
    __publicField$2(this, "_runnings", 0);
    /**
     * @internal
     */
    __publicField$2(this, "_shouldSchedule", false);
    /**
     * @internal
     */
    __publicField$2(this, "_depsLength", 0);
...
class ComputedRefImpl {
  constructor(getter, _setter, isReadonly, isSSR) {
    ...
    __publicField$1(this, "effect");
    __publicField$1(this, "__v_isRef", true);
    __publicField$1(this, "__v_isReadonly", false);
    __publicField$1(this, "_cacheable");
