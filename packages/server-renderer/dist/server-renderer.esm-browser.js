...
class EffectScope {
  constructor(detached = false) {
     ...
     * @internal
     */
    __publicField$2(this, "_active", true);
    /**
     * @internal
     */
    __publicField$2(this, "effects", []);
    /**
     * @internal
     */
    __publicField$2(this, "cleanups", []);
    /**
...
class ReactiveEffect {
  constructor(fn, trigger, scheduler, scope) {
    ...
    __publicField$1(this, "active", true);
    /**
     ...
     * @internal
     */
    __publicField$1(this, "computed");
    /**
     * @internal
     */
    __publicField$1(this, "allowRecurse");
    __publicField$1(this, "onStop");
    // dev only
    __publicField$1(this, "onTrack");
    // dev only
    __publicField$1(this, "onTrigger");
    /**
     * @internal
     */
    __publicField$1(this, "_dirtyLevel", 2);
    /**
     * @internal
     */
    __publicField$1(this, "_trackId", 0);
    /**
     * @internal
     */
    __publicField$1(this, "_runnings", 0);
    /**
     * @internal
     */
    __publicField$1(this, "_shouldSchedule", false);
    /**
     * @internal
     */
    __publicField$1(this, "_depsLength", 0);
...
function triggerEffects(dep, dirtyLevel, debuggerEventExtraInfo) {
  ...
  for (const effect2 of dep.keys()) {
    if (effect2._dirtyLevel < dirtyLevel && // 上一次没有dirty，这一次dirty，如果上一次正在dirty中，说明上一次副作用函数还没执行完，每次执行副作用函数之前都会把dirty设置为notdirty
...
class ComputedRefImpl {
  constructor(getter, _setter, isReadonly, isSSR) {
    ...
    __publicField(this, "__v_isReadonly", false);
    __publicField(this, "_cacheable");
...
function createBaseVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, shapeFlag = type === Fragment ? 0 : 1, isBlockNode = false, needFullChildrenNormalization = false) {
  const vnode = {
    ...
    // 表示节点的插槽作用域ID
    children,
    // 表示节点的子节点，可以是字符串、VNode对象或者VNode数组
    component: null,
    // 表示节点对应的组件实例
    suspense: null,
    ssContent: null,
...
//# sourceMappingURL=server-renderer.esm-browser.js.map
